...
Provides JSON serialization for AST and CST structures, enabling
persistence and transport of parsed specifications.
"""

import json

from lexical import SyntaxTree, FrozenNode
